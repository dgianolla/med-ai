import { PriorityLeadsBoard } from "@/components/PriorityLeadsBoard";
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          <nav className="flex gap-4 pt-1 flex-1 px-8">
            ...
            <Link href="/leads/encaixe" className="text-sm font-medium text-green-600 dark:text-green-500 border-b-2 border-green-600 dark:border-green-500 py-4">Encaixe</Link>
